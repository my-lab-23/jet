...
@Composable
fun InputScreen(switch: NavHostController) {

    val focusManager = LocalFocusManager.current
    val (uno, due, tre) = FocusRequester.createRefs()

    var input0 by rememberSaveable { mutableStateOf("nome") }
    var input1 by rememberSaveable { mutableStateOf("cognome") }
    var input2 by rememberSaveable { mutableStateOf("telefono") }
    ...
    Column(
        ...
        Button(
            ...
            Text("Salva contatto", fontSize = 40.sp)
        }
